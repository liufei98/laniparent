        ...
        <div id="cm-menu-items-wrapper">
            <div id="cm-menu-scroller">
                <ul class="cm-menu-items">
                    <li class="active"><a href="index.html" class="sf-profile">管理员</a></li>
                    <li><a href="user.html" class="sf-profile-group">用户管理</a></li>
                ...
                <div class="row">
                    <!--模糊查询-->
                        ...
                        <div style="width: 400px; float: right; margin-bottom: 20px;" class="input-group">
                            <input type="text" name="username" class="form-control" placeholder="输入超级用户名">
